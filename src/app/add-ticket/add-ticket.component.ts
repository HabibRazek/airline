...
export class AddTicketComponent implements OnInit {
  ...
  AddTicket() {
    this.newTicket.flight = this.flights.find(
      (fly) => fly.idFlight == this.newIdflight
    )!;
    this.newTicket.passenger = this.passengers.find(
      (cat) => cat.idPassenger == this.newIdpassenger
    )!;
